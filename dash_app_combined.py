...
@app.callback(
    ...
    #     Output('chart1-color-toggle', 'options')
    # ],
    Output('top-offending-publishers-bar-chart', 'figure'),
    [
...
def update_chart1(selected_start_date, selected_end_date, selected_publishers, selected_bias_ratings, selected_bias_categories, selected_topics, color_by):
    ...
    #     options=[
    #             {'label': '    Show bias ratings', 'value': 'bias_ratings'},
    #             {'label': '    Show bias categories (No articles found in the current selection.)', 'value': 'bias_categories', 'disabled':True}
    #         ]
    # else:
    #     options=[
    #             {'label': '    Show bias ratings', 'value': 'bias_ratings'},
...
@app.callback(
    ...
    # [
    #     State('chart4-datepickerrange', 'start_date'),
    #     State('chart4-datepickerrange', 'end_date'),
    #     State('chart4-publisher-dropdown', 'value'),
    #     State('chart4-topic-dropdown', 'value'),
    #     State('chart4-bias-category-dropdown', 'value'),
    #     State('chart4-bias-rating-dropdown', 'value'),
    #     State('chart4-text-toggle', 'value'),
